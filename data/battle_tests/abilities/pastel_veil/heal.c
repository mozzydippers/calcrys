// Test: Moldbreaker - Pastel Veil Heal
...
const struct TestBattleScenario BattleTests[] = {
...

    {
        ...
        .expectations = {
            ...
            { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "Ponyta cured its poison status with its Pastel Veil!" },
        }
    },
#ifndef GET_TEST_CASE_ONLY
};
