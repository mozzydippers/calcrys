// Test: Unnerve - ability popup on first turn and switch
...
BEGIN_TEST {
    ...
    .expectations = {
        { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "Rookidee's Unnerve" },
        ...
        { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "Calyrex's Unnerve" },
        { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "Your side is too nervous to eat Berries!" },
    },
} END_TEST
