// Test: Bulldoze - doubles, one target has Levitate
...
const struct TestBattleScenario BattleTests[] = {
...

    {
        ...
        .expectations = {
            ...
            { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "It doesn't affect the opposing Treecko..." },
            { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "It's super effective on Charmander!" },
            { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "It's not very effective on the opposing Chikorita." },
