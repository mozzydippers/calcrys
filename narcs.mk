...
OVERWORLDS_EXTRAS_SRCS := $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/extras/*.png) $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/extras/*.json) $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/extras/*.pal)
OVERWORLDS_EXTRAS_OBJS := $(patsubst $(OVERWORLDS_DEPENDENCIES_DIR)/extras/%.png,$(OVERWORLDS_DIR)/2_%.btx0,$(OVERWORLDS_EXTRAS_SRCS))

# add your own overworld sources here
ALL_OVERWORLDS_SRCS := $(OVERWORLDS_SRCS) $(OVERWORLDS_EXTRAS_SRCS)
ALL_OVERWORLDS_OBJS := $(OVERWORLDS_OBJS) $(OVERWORLDS_EXTRAS_OBJS)
...
$(OVERWORLDS_DIR)/2_%.btx0:$(OVERWORLDS_DEPENDENCIES_DIR)/extras/%.png $(OVERWORLDS_DEPENDENCIES_DIR)/extras/%.json $(OVERWORLDS_DEPENDENCIES_DIR)/extras/%*.pal
	$(BTX) $< $@
