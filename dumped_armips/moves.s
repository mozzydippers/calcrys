...
movedata MOVE_BIDE, "Bide"
    ...
    target 16
    priority 1
    flags FLAG_CONTACT | FLAG_PROTECT | FLAG_KINGS_ROCK | FLAG_KEEP_HP_BAR
    appeal 0x0f
    contesttype CONTEST_TOUGH
    terminatedata
...
movedata MOVE_SAPPY_SEED, "Sappy Seed"
    ...
    target MOVEDATA_BATTLE_EFFECT
    priority 0
    flags FLAG_PROTECT | FLAG_MAGIC_COAT | FLAG_MIRROR_MOVE | FLAG_KINGS_ROCK | FLAG_KEEP_HP_BAR
    appeal 0x00
    contesttype CONTEST_COOL
    terminatedata
...
movedata MOVE_MIGHTY_CLEAVE, "Mighty Cleave"
    ...
    target MOVEDATA_BATTLE_EFFECT
    priority 0
    flags FLAG_CONTACT | FLAG_MIRROR_MOVE | FLAG_KINGS_ROCK | FLAG_KEEP_HP_BAR
    appeal 0x00
    contesttype CONTEST_COOL
    terminatedata
...
movedatanoname NUM_OF_MOVES    battleeffect MOVE_EFFECT_HIT
    pss SPLIT_SPECIAL
    basepower 100
    type TYPE_NORMAL
    accuracy 100
