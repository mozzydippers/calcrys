...
// calcrys custom
#define BATTLE_SUBSCRIPT_OVERWORLD_GRAVITY_RADIO_WAVES         (MAX_BASE_SUBSCRIPT_NUM + 1)
#define BATTLE_SUBSCRIPT_OVERWORLD_TAILWIND                    (MAX_BASE_SUBSCRIPT_NUM + 2)
#define BATTLE_SUBSCRIPT_OVERWORLD_TERRAIN_TRICK_ROOM          (MAX_BASE_SUBSCRIPT_NUM + 3)
#define BATTLE_SUBSCRIPT_WATER_VEIL_AQUA_RING                  (MAX_BASE_SUBSCRIPT_NUM + 4)
#define BATTLE_SUBSCRIPT_OVERWORLD_RADIO_WAVES                 (MAX_BASE_SUBSCRIPT_NUM + 5)
#define BATTLE_SUBSCRIPT_OVERWORLD_RAIN_RADIO_WAVES            (MAX_BASE_SUBSCRIPT_NUM + 6)
#define BATTLE_SUBSCRIPT_OVERWORLD_SUN_RADIO_WAVES             (MAX_BASE_SUBSCRIPT_NUM + 7)
#define BATTLE_SUBSCRIPT_OVERWORLD_TRICK_ROOM_RADIO_WAVES      (MAX_BASE_SUBSCRIPT_NUM + 8)
#define BATTLE_SUBSCRIPT_OVERWORLD_WATER_SPORT                 (MAX_BASE_SUBSCRIPT_NUM + 9)
#define BATTLE_SUBSCRIPT_OVERWORLD_STRONG_WINDS                (MAX_BASE_SUBSCRIPT_NUM + 10)
