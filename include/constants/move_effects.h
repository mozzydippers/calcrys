...
#define MOVE_EFFECT_HEAL_TARGET (MAX_BASE_MOVE_EFFECT_NUM + 2)
#define MOVE_EFFECT_POLLEN_PUFF (MAX_BASE_MOVE_EFFECT_NUM + 3)
#define MOVE_EFFECT_COACHING (MAX_BASE_MOVE_EFFECT_NUM + 4)
#define MOVE_EFFECT_DOUBLE_POWER_IF_FASTER (MAX_BASE_MOVE_EFFECT_NUM + 5)
