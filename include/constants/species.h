...
#define SPECIES_GIGANTAMAX_VENUSAUR (MAX_SPECIES_PALDEAN_FORM_NUM)
#define SPECIES_GIGANTAMAX_CHARIZARD (MAX_SPECIES_PALDEAN_FORM_NUM + 1)
#define SPECIES_GIGANTAMAX_BLASTOISE (MAX_SPECIES_PALDEAN_FORM_NUM + 2)
#define SPECIES_GIGANTAMAX_BUTTERFREE (MAX_SPECIES_PALDEAN_FORM_NUM + 3)
#define SPECIES_GIGANTAMAX_PIKACHU (MAX_SPECIES_PALDEAN_FORM_NUM + 4)
#define SPECIES_GIGANTAMAX_MEOWTH (MAX_SPECIES_PALDEAN_FORM_NUM + 5)
#define SPECIES_GIGANTAMAX_MACHAMP (MAX_SPECIES_PALDEAN_FORM_NUM + 6)
#define SPECIES_GIGANTAMAX_GENGAR (MAX_SPECIES_PALDEAN_FORM_NUM + 7)
#define SPECIES_GIGANTAMAX_KINGLER (MAX_SPECIES_PALDEAN_FORM_NUM + 8)
#define SPECIES_GIGANTAMAX_LAPRAS (MAX_SPECIES_PALDEAN_FORM_NUM + 9)
#define SPECIES_GIGANTAMAX_EEVEE (MAX_SPECIES_PALDEAN_FORM_NUM + 10)
#define SPECIES_GIGANTAMAX_SNORLAX (MAX_SPECIES_PALDEAN_FORM_NUM + 11)
#define SPECIES_GIGANTAMAX_GARBODOR (MAX_SPECIES_PALDEAN_FORM_NUM + 12)
#define SPECIES_GIGANTAMAX_MELMETAL (MAX_SPECIES_PALDEAN_FORM_NUM + 13)
#define SPECIES_GIGANTAMAX_RILLABOOM (MAX_SPECIES_PALDEAN_FORM_NUM + 14)
#define SPECIES_GIGANTAMAX_CINDERACE (MAX_SPECIES_PALDEAN_FORM_NUM + 15)
#define SPECIES_GIGANTAMAX_INTELEON (MAX_SPECIES_PALDEAN_FORM_NUM + 16)
#define SPECIES_GIGANTAMAX_CORVIKNIGHT (MAX_SPECIES_PALDEAN_FORM_NUM + 17)
#define SPECIES_GIGANTAMAX_ORBEETLE (MAX_SPECIES_PALDEAN_FORM_NUM + 18)
#define SPECIES_GIGANTAMAX_DREDNAW (MAX_SPECIES_PALDEAN_FORM_NUM + 19)
#define SPECIES_GIGANTAMAX_COALOSSAL (MAX_SPECIES_PALDEAN_FORM_NUM + 20)
#define SPECIES_GIGANTAMAX_FLAPPLE (MAX_SPECIES_PALDEAN_FORM_NUM + 21)
#define SPECIES_GIGANTAMAX_APPLETUN (MAX_SPECIES_PALDEAN_FORM_NUM + 22)
#define SPECIES_GIGANTAMAX_SANDACONDA (MAX_SPECIES_PALDEAN_FORM_NUM + 23)
#define SPECIES_GIGANTAMAX_TOXTRICITY (MAX_SPECIES_PALDEAN_FORM_NUM + 24)
#define SPECIES_GIGANTAMAX_TOXTRICITY_LOW_KEY (MAX_SPECIES_PALDEAN_FORM_NUM + 25)
#define SPECIES_GIGANTAMAX_CENTISKORCH (MAX_SPECIES_PALDEAN_FORM_NUM + 26)
#define SPECIES_GIGANTAMAX_HATTERENE (MAX_SPECIES_PALDEAN_FORM_NUM + 27)
#define SPECIES_GIGANTAMAX_GRIMMSNARL (MAX_SPECIES_PALDEAN_FORM_NUM + 28)
#define SPECIES_GIGANTAMAX_ALCREMIE (MAX_SPECIES_PALDEAN_FORM_NUM + 29)
#define SPECIES_GIGANTAMAX_COPPERAJAH (MAX_SPECIES_PALDEAN_FORM_NUM + 30)
#define SPECIES_GIGANTAMAX_DURALUDON (MAX_SPECIES_PALDEAN_FORM_NUM + 31)
#define SPECIES_GIGANTAMAX_URSHIFU (MAX_SPECIES_PALDEAN_FORM_NUM + 32)
#define SPECIES_GIGANTAMAX_URSHIFU_RAPID_STRIKE (MAX_SPECIES_PALDEAN_FORM_NUM + 33)
