...
BOOL btl_scr_cmd_124_CheckTrainerGimmickMessage(void *bsys UNUSED, struct BattleStruct *ctx);
...
#define BASE_ENGINE_BTL_SCR_CMDS_MAX 0x124
...
const btl_scr_cmd_func NewBattleScriptCmdTable[] = {
    ...
    [0x124 - START_OF_NEW_BTL_SCR_CMDS] = btl_scr_cmd_124_CheckTrainerGimmickMessage,
...
BOOL btl_scr_cmd_123_SetAuraBoost(void *bsys UNUSED, struct BattleStruct *ctx)
{
    ...
    ArchiveDataLoadOfs(&battleData, ARC_CODE_ADDONS, CODE_ADDON_TOTEMBATTLES, battleVariationInfo.slot * sizeof(struct TotemBattle), sizeof(struct TotemBattle));
