...
BOOL btl_scr_cmd_120_SetAuraBoost(void *bsys UNUSED, struct BattleStruct *ctx);
BOOL btl_scr_cmd_121_CheckTrainerGimmickMessage(void *bsys UNUSED, struct BattleStruct *ctx);
...
#define BASE_ENGINE_BTL_SCR_CMDS_MAX 0x121
...
const btl_scr_cmd_func NewBattleScriptCmdTable[] =
{
    ...
    [0x120 - START_OF_NEW_BTL_SCR_CMDS] = btl_scr_cmd_120_SetAuraBoost,
    [0x121 - START_OF_NEW_BTL_SCR_CMDS] = btl_scr_cmd_121_CheckTrainerGimmickMessage,
