...
struct OVERWORLD_TAG gOWTagToFileNum[] = // skip down a bit to see the parts that are specifically for pokémon
    {
        ...
        { .tag = NEW_NPC_TAG_START + 3, .gfx = NEW_NPC_GFX_START + 2, .callback_params = 0x0420 },
        ...
        { .tag = NEW_NPC_TAG_START + 7, .gfx = NEW_NPC_GFX_START + 4, .callback_params = OVERWORLD_SIZE_SMALL },
        { .tag = NEW_NPC_TAG_START + 8, .gfx = MON_OVERWORLD_GFX_START + SPECIES_FLAAFFY, .callback_params = OVERWORLD_SIZE_SMALL },
        { .tag = NEW_NPC_TAG_START + 9, .gfx = NEW_NPC_GFX_START + 5, .callback_params = 0x0420 },
